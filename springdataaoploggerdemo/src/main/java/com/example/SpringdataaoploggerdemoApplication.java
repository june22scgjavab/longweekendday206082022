...
import com.example.utility.LoggingAspect;


@SpringBootApplication
public class SpringdataaoploggerdemoApplication implements CommandLineRunner {
	@Autowired
	...
	public static final  Logger LOGGER = LogManager.getLogger(SpringdataaoploggerdemoApplication.class);
	public static void main(String[] args) {
		SpringApplication.run(SpringdataaoploggerdemoApplication.class, args);
	}
